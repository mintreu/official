...
useSeoMeta({
  title: 'Products | Mintreu - Premium Code Solutions & APIs',
  description: 'Browse our marketplace for ready-made templates, API subscriptions, and code resources for your projects.'
})
</script>
