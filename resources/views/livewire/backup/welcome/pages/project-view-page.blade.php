                ...
                <div class="homepage-section-content">
                    ...
                    <div class="w-full text-left justify-normal mt-6">
                        <div class="flex gap-3">
                            ...
                            <div>
                                <select wire:model="filterType" wire:change="updateFilterType"
                                        class="bg-transparent px-6 py-2 rounded-lg border-none">
                        ...
                        @if($record->products?->count())
                            <div class="p-3">
                                @foreach($record->products->groupBy('type')->sortKeys() as $type => $products)
                                    <h2 class="text-2xl font-bold my-4">{{ \App\Models\Enums\Product\ProductTypeCast::from($type)->getLabel() }}</h2>
