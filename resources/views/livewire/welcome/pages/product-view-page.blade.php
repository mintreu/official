                ...
                <div class="homepage-section-content">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <div class="w-full flex justify-center items-center transform transition-transform duration-200 hover:scale-105">
                            <img src="{{ $record->getFirstMediaUrl('displayImage', 'thumb') }}" alt="{{ $record->name }}" class="rounded-lg ">
                        </div>
                        ...
                        <div class="w-full bg-black/50 p-4 rounded-2xl ">
                            ...
                            @guest()
                            <button class="px-5 py-2 my-6 mx-auto  rounded-2xl bg-fuchsia-600 hover:bg-blue-600 transform transition-transform duration-200 hover:scale-105">Login to subscribe</button>
                            @endguest
                    ...
                    <div x-data="{ open: false }" class=" mx-auto p-3 w-full bg-black/50 rounded-2xl my-2 ">
                            ...
                            @foreach($images as $index => $image)
                                @if($index < 4)
                                    ...
                                    <div class="col-span-1">
                                        <img src="{{ $image['src'] }}" alt="{{ $image['alt'] }}" class="w-full h-auto cursor-pointer object-cover rounded-md transform transition-transform duration-200 hover:scale-105" @click="openModal({{ $index }})">
                                    </div>
                                @else
                                    <!-- Show only the first row by default, the rest when expanded -->
                                    <template x-if="open">
                        ...
                        <button @click="open = !open" class="bg-fuchsia-600 text-white hover:text-blue-800 my-2 px-4 py-1 rounded-xl">
                        ...
                        <div x-show="showModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                             ...
                             class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75 z-50" @click.self="closeModal">
                            <div class="relative w-full max-w-4xl mx-auto">
                                <button @click="prevImage" class="absolute top-1/2 left-4 transform -translate-y-1/2 text-white bg-gray-800 rounded-full p-2 focus:outline-none">
                                    &larr;
                                </button>
                                <button @click="nextImage" class="absolute top-1/2 right-4 transform -translate-y-1/2 text-white bg-gray-800 rounded-full p-2 focus:outline-none">
                                    &rarr;
                                </button>
                                <button @click="closeModal" class="absolute top-4 right-4 text-white bg-gray-800 rounded-full p-2 focus:outline-none">
                                    &times;
                                </button>
                    ...
                    @if($record->type == \App\Models\Enums\ProductTypeCast::API)
                        {{-- Compatibilities --}}
                        <section class="w-full">
                            <div class="container p-6 mx-auto space-y-6 text-center lg:p-8 lg:space-y-8">
                                ...
                                <div class="flex flex-wrap justify-center lg:justify-between">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Angular" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Angular</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Gatsby" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Gatsby</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Plain HTML" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Next.js" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Next.js</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Nuxt.js" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Nuxt.js</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="React" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>React</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Svelte" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Svelte</title>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-label="Vue.js" class="w-12 h-12 mx-10 my-6 fill-current md:mx-12 lg:m-0 transform transition-transform duration-200 hover:scale-105 hover:fill-fuchsia-700">
                                        <title>Vue.js</title>
                    ...
                    @if($record->type == \App\Models\Enums\ProductTypeCast::API)
                        ...
                        <div class="flex flex-col gap-3 justify-normal my-4 bg-black/50 text-left px-5 py-3 border-4 border-blue-600 rounded-2xl">
                            ...
                            <fieldset class="w-full">
                                ...
                                <div class="flex w-full items-center">
                                    ...
                                    <button class="px-5 py-1  mb-4 mx-auto  rounded-2xl bg-fuchsia-600 hover:bg-blue-600">Visit Demo</button>
                                </div>
                            </fieldset>
                        ...
                        <div class="m-2 p-3 bg-black/50 rounded-2xl">
                            ...
                            <table class="w-full divide-y divide-gray-200">
                                <thead class="">
                                <tr>
                                    <th scope="col" class="px-6 py-3 text-center text-md font-medium  uppercase tracking-wider ">
                                        Plan
                                    </th>
                                    <th scope="col" class="px-6 py-3 text-center text-md font-medium  uppercase tracking-wider ">
                                        Subscription
                                ...
                                @foreach ($plans as $plan)
                                    <tr class="text-sm font-medium">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap transform transition-transform duration-200 cursor-pointer  @if($plan->is_recommended) bg-blue-600 font-semibold text-lg  @else hover:scale-105 @endif">
                                            ...
                                            @auth
                                                <button wire:click="startProject('{{ $plan->url }}')" class="px-4 py-2 bg-fuchsia-600 rounded-full text-white hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-fuchsia-500">
                                                    Select Plan
                                                </button>
                                            @endauth
                                ...
                                @foreach($record->project->products as $product)
                                    <div class="col-span-1 w-full border border-gray-200 rounded-lg overflow-hidden transform transition-transform duration-200 hover:scale-105">
                                        <div class="relative w-full">
                                            <img src="{{ $product->getFirstMediaUrl('displayImage') }}" alt="{{ $product->name }}" class="w-full h-64 object-cover">
