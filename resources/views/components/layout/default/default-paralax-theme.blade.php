...
<div class="bg-black text-white min-h-screen">
    ...
    <div class=" bg-transparent w-full">
        ...
        <div x-data="{ isOpen: false, activeSection: 'home' }" class="relative">
            ...
            {{-- Mobile Sidebar --}}
            <div x-show="isOpen" class="md:hidden absolute z-20 top-0 left-0 bottom-0 w-full h-screen py-10 px-6 flex flex-col bg-black"
                ...
                <div class="flex flex-col gap-3 justify-center mt-6 mb-auto text-xl bg-black">
    ...
    <div class="relative h-full  ">
        <div class="absolute top-0 bottom-0 left-0 right-0 mt-12 mx-10 overflow-y-scroll overflow-hidden   scrollbar-line">
            {{ $slot }}
        </div>
