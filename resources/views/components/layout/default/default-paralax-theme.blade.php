...
<div x-data="{ isOpen: false, activeSection: 'home' }" class="h-full w-full relative text-white bg-green-600  ">

{{--     Navigation (Responsive: Sidebar on Mobile, Top Navbar on Desktop)--}}
    <div class="w-full absolute z-20 h-12 bg-transparent px-6 flex justify-center gap-2 items-center">
    ...
    <div x-show="isOpen" class="md:hidden absolute z-20 top-0 left-0 bottom-0 w-full bg-black py-10 px-6 flex flex-col "
        ...
        <div class="flex justify-between items-center">
            ...
            <button @click="isOpen = false" class="text-white hover:text-purple-500">@svg('heroicon-c-x-mark', 'w-10 h-10')</button>
        </div>
    ...
    {{-- Main Content --}}
    <div class=" h-screen w-full relative flex flex-col  overflow-hidden mx-auto">
        <div class="absolute bottom-0 top-0 left-0 right-0 p-3">
            {{ $slot }}
        </div>
