    ...
    public function run(): void
    {
        ...
        $shopcoreApi = Product::query()->updateOrCreate(
            ...
            [
                ...
                'short_description' => 'Managed commerce API subscription for high-performance online retail operations.',
                'description' => 'Production-ready commerce API for catalog, cart, checkout, and order workflows.',
                'content' => '<h2>API Product</h2><p>Production-grade API access for retail operations.</p><h2>Commerce Catalog</h2><p>Compatible with curated niche product experiences.</p>',
        ...
        $helpdeskApi = Product::query()->updateOrCreate(
            ...
            [
                ...
                'short_description' => 'Managed support API subscription for ticketing, messaging, live chat, and AI workflows.',
                'description' => 'Production-ready support API for ticket management, replies, escalations, and service operations.',
                'content' => '<h2>API Product</h2><p>Production-grade API access for customer support operations.</p><h2>Support Catalog</h2><p>Compatible with dedicated support product experiences.</p>',
    ...
    private function upsertTemplate(array $data, array $context): void
    {
        ...
        $product = Product::query()->updateOrCreate(
            ...
            [
                ...
                'description' => sprintf('Production-ready %s frontend product with complete business workflows.', $contentLabel),
